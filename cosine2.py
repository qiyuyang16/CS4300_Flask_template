...
def get_query_vector(query, tfidf_vectorizer):
    ...
    for w in preprocessing2.preprocess(query).split(' '):
        try:
...
#     pages = preprocessing2.get_pages('../streamlit_testing/pdftotext_result.txt')
#     (formatted_docs, paragraph_page_idx) = preprocessing2.get_formatted_docs(pages, 0.33)
