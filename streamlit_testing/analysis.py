...
if file is not None:
    ...
    preprocessed_docs = prerocessing.get_preprocessed_docs(formatted_docs)
    ...
    tfidf_matrix = cosine.tfidf_vectorizer.fit_transform(list(preprocessed_docs.values())).toarray()
